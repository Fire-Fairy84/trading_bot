...
La configuración de validación mantiene la API de Freqtrade desactivada por defecto. Si se activa en local, conviene limitarla a `localhost` y usar credenciales propias.
